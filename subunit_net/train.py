...
from divisivenormalization.models import ConvSubunitNetOutputNonlin
...
def main():
    ...
    base_dir = "/projects/burg2021_learning-divisive-normalization/subunit_net"
    fname = "results.csv"
    param_dict = {
        "run_no": None,
    ...
    for _ in range(1000):
        ...
        try:
            model = ConvSubunitNetOutputNonlin(
                filter_sizes,
                out_channels,
                strides,
                paddings,
