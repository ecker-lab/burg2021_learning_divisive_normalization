...
from divisivenormalization.models import DivisiveNetUnspecificOutputNonlin
...
def main():
    ...
    base_dir = "/projects/burg2021_learning-divisive-normalization/nonspecific_divisive_net"
    fname = "results.csv"
    param_dict = {
        "run_no": None,
    ...
    for _ in range(1000):
        ...
        try:
            model = DivisiveNetUnspecificOutputNonlin(
                filter_sizes,
                out_channels,
                strides,
                paddings,
